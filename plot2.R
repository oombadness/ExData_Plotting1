...
##
## Exploratory Data Analysis Project 1 - Graphing - plot2
##
...
##
## Make a line graph of time on the X and GAP (KW) on the Y
print("Exploratory Data Analysis Graph plot2.R")
...
dev.off()
print("Graph directed to plot2.png in working directory")